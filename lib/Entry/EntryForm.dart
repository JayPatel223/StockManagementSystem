...
class EntryForm extends StatefulWidget {
  ...
  const EntryForm({super.key, this.entrydata});
...
class _EntryFormState extends State<EntryForm> {
  ...
  void _populateFields(EntryModel entry) {
    setState(() {
      ...
      _sellerNameController.text = entry.sellerName;
  ...
  void initState() {
    ...
    if (widget.entrydata != null) {
      _populateFields(widget.entrydata!);
    }
    _fetchProductList();
  }
  ...
  Future<void> saveData() async {
    ...
    try {
      ...
      if (_entryId == null) {
        ...
        DocumentReference docRef = FirebaseFirestore.instance.collection('DataEntry').doc(_entryId);
        ...
        final index = GlobalData.entryData.indexWhere((e) => e.id == _entryId);
        if (index != -1) {
          GlobalData.entryData[index] = updatedEntry;
        }

        int oldstock = widget.entrydata?.productQuantity ?? 0;
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: TextButton(
                    ...
                    child: Text(
                      widget.entrydata != null ? 'Update' : 'Submit',
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: 18.0,
                      ),
